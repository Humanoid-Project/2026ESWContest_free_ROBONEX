...
실행 스크립트의 전체 파라미터 목록은 [scripts/README.md](scripts/README.md)를 참고하세요. 이 문서는 학습 실행·성능 검증을 의미하지 않습니다.
...
| 기준 높이 유지 `base_height` · `-10.0` | `B(z_base - 1.0710, 2)` | 몸체 높이를 기준값 `1.0710 m` 부근에 유지 |
